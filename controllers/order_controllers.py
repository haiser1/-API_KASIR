...
def create_order_controller(current_user) -> dict:
    ...
    response_data = create_order_service(request_data, current_user['id'])
    return response_data

@token_required
def get_all_order_controller(current_user, start_date, end_date) -> dict:
    response_data = get_all_order_service(start_date, end_date)
    return response_data
